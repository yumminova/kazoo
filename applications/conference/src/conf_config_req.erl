...
-spec lookup_and_send_profile(kz_json:object(), kapps_conference:conference(), ne_binary()) -> 'ok'.
...
-spec fix_profile(kapps_conference:conference(), ne_binary(), api_object()) -> kz_json:object().
