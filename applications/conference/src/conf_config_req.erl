...
-spec handle_request(ne_binary(), kz_json:object(), kz_proplist()) -> 'ok'.
...
-spec lookup_and_send_profile(kz_json:object(), kz_proplist(), ne_binary()) -> 'ok'.
...
-spec get_conference_profile(kz_json:object() | ne_binary(), ne_binary()) -> 'ok'.
...
-spec fix_profile(kapps_conference:conference(), api_object()) -> kz_json:object().
...
-spec get_control_profile(kz_json:object() | ne_binary(), ne_binary()) -> 'ok'.
