...
-spec directory_resp_endpoint_xml(api_terms()) -> {'ok', iolist()}.
...
-spec route_resp_fold(kz_json:object(), route_resp_fold_acc()) ->
                             route_resp_fold_acc().
-spec route_resp_fold(kz_json:object(), route_resp_fold_acc(), ne_binary()) ->
                             route_resp_fold_acc().
...
-spec unset_custom_sip_headers() -> xml_el().
...
-spec route_resp_ccvs(kz_json:object()) -> xml_el().
route_resp_ccvs(JObj) ->
...
-spec route_resp_cavs(kz_json:object()) -> xml_el() | 'undefined'.
...
-spec get_profile_params(kz_json:object() | kz_proplist()) -> kz_proplist().
...
-spec get_profile_param(tuple(), kz_proplist()) -> kz_proplist().
...
-spec get_channel_params(kz_json:object() | kz_proplist()) -> kz_proplist().
...
-spec arrange_acl_node({ne_binary(), kz_json:object()}, orddict:orddict()) -> orddict:orddict().
...
%%%-------------------------------------------------------------------
-spec acl_node_el(xml_attrib_value(), xml_attrib_value()) -> xml_el() | xml_els().
...
-spec prepend_child(xml_el(), xml_el() | xml_els()) -> xml_el().
...
-spec sofia_gateway_vars_xml_to_json(xml_el() | xml_els(), kz_json:object()) -> kz_json:object().
