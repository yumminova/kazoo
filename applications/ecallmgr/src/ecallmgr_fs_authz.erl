...
-spec authorize(kz_evt_freeswitch:data(), ne_binary(), atom()) -> authz_reply().
...
-spec maybe_channel_recovering(kz_evt_freeswitch:data(), ne_binary(), atom()) -> authz_reply().
...
-spec is_authz_enabled(kz_evt_freeswitch:data(), ne_binary(), atom()) -> authz_reply().
...
-spec is_global_resource(kz_evt_freeswitch:data(), ne_binary(), atom()) -> authz_reply().
...
-spec is_consuming_resource(kz_evt_freeswitch:data(), ne_binary(), atom()) -> authz_reply().
...
-spec is_consuming_outbound_resource(kz_evt_freeswitch:data(), ne_binary(), atom()) -> authz_reply().
is_consuming_outbound_resource(Props, CallId, Node) ->
...
-spec is_consuming_inbound_resource(kz_evt_freeswitch:data(), ne_binary(), atom()) -> authz_reply().
is_consuming_inbound_resource(Props, CallId, Node) ->
...
-spec request_channel_authorization(kz_evt_freeswitch:data(), ne_binary(), atom()) ->
                                           authz_reply().
...
-spec authz_response(kz_json:object(), kz_evt_freeswitch:data(), ne_binary(), atom()) -> authz_reply().
...
-spec authorize_account(kz_json:object(), kz_evt_freeswitch:data(), ne_binary(), atom()) ->
                               authz_reply().
...
-spec authorize_reseller(kz_json:object(), kz_evt_freeswitch:data(), ne_binary(), atom()) ->
                                authz_reply().
...
-spec set_ccv_trunk_usage(kz_json:object(), kz_evt_freeswitch:data(), ne_binary(), atom()) ->
                                 authz_reply().
...
-spec rate_call(kz_evt_freeswitch:data(), ne_binary(), atom()) -> authz_reply().
rate_call(Props, CallId, Node) ->
    _P = kz_util:spawn(fun rate_channel/2, [Props, Node]),
    lager:debug("rating call in ~p", [_P]),
    allow_call(Props, CallId, Node).

-spec allow_call(kz_evt_freeswitch:data(), ne_binary(), atom()) -> authz_reply().
...
-spec authz_default(kz_evt_freeswitch:data(), ne_binary(), atom()) -> {'ok', ne_binary()} | boolean().
...
-spec authz_req(kz_evt_freeswitch:data()) -> kz_proplist().
authz_req(Props) ->
    AccountId = kz_evt_freeswitch:account_id(Props),
...
-spec rating_req(ne_binary(), kz_evt_freeswitch:data()) -> kz_proplist().
