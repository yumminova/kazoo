...
-define(NAME, <<"Outbound Fax">>).
-define(DESC, <<"This webhook is triggered when an outbound fax is sent or if there is an error during an attempt">>).
-define(METADATA
...
-spec format_outbound_fax_event(kz_json:object()) -> kz_json:object().
