...
-record(kapps_conference, {id :: api_ne_binary()
                          ,name :: api_ne_binary()
                          ,focus :: api_ne_binary()
                          ,language :: api_ne_binary()
                          ,domain :: api_ne_binary()
                          ,profile_name = 'undefined' :: api_binary()
                          ,profile = 'undefined' :: api_object()
                          ...
                          ,max_members_media :: api_ne_binary()
...
-spec controls(conference()) -> api_object().
controls(#kapps_conference{controls=Controls}) -> Controls.

-spec set_controls(api_object(), conference()) -> conference().
...
-spec profile_name(conference(), api_binary()) -> api_binary().
...
-spec language(conference()) -> api_binary().
...
-spec raw_domain(conference()) -> api_binary().
raw_domain(#kapps_conference{domain=Domain}) ->
    Domain.

-spec set_domain(ne_binary(), conference()) -> conference().
...
-spec member_pins(conference()) -> ne_binaries().
...
-spec max_members_media(conference()) -> api_binary().
max_members_media(#kapps_conference{max_members_media = Value}) -> Value.

-spec set_max_members_media(ne_binary(), conference()) -> conference().
